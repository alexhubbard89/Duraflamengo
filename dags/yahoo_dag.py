...
## make DAG tree
dag = DAG(dag_id='yahoo-trending-collection',
...
collect_yahoo_trending = PythonOperator(
    ...
    python_callable=yahoo.get_yahoo_trending,
    dag=dag,
)
...
clear_buffer_yahoo_trending = PythonOperator(
    ...
    python_callable=yahoo.clear_yahoo_trending_buffer,
    dag=dag,
)

[
    collect_yahoo_trending >>
    migrate_yahoo_trending >>
    clear_buffer_yahoo_trending
]
