...
## make DAG tree
dag = DAG(
    dag_id="tda-minute-by-minute-intraday-price-collection",
...
collect_tda_minute_watchlist = SparkSubmitOperator(
    task_id="collect_tda_minute_watchlist",
    application=f"{pyspark_app_home}/dags/econ/runner/collect_tda_minute_watchlist.py",
    executor_memory="15g",
    driver_memory="15g",
    name="collect_tda_minute_watchlist",
